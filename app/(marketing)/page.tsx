...
export default function Home() {
  return (
    <div className="max-w-[988px] mx-auto flex-1 w-full flex flex-col lg:flex-row items-center justify-center p-4 gap-2" style={{
      background: "radial-gradient(circle, rgba(16,185,75,0.5) 0%, transparent 70%)"
    }}>
      ...
      <div className="flex flex-col items-center gap-y-8">
        ...
        <div className="flex flex-col items-center gap-y-3 max-w-[330px] w-full">
          ...
          <ClerkLoaded>
            ...
            <SignedIn>
              <Button size="lg" variant="secondary" w-full asChild>
                <Link href="/learn">
                  Continue Learning
                </Link>
              </Button>
