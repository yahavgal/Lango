...
export const PracticeModal = () => {
    ...
    const { isOpen, close } = usePracticeModal(); // Hook to control the modal's visibility.
            ...
            <DialogContent className="max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-center text-base">
                        Use practice mode to regain hearts and points. You cannot lose hearts or points in practice mode.
                    </DialogDescription>
                </DialogHeader>
